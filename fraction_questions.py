...
def quiz_adding_fractions(a=1, b=10, num=10):
    ...
    for i in range(num):
        ...
        if check_answer(num1_sym+num2_sym, answer):
            ...
            print("Incorrect. Correct answer is ", num1_sym+num2_sym, ". Remember to check where you went wrong before moving on.")
...
def quiz_fraction_mania(a=1, b=10, num=10):
    ...
    for i in range(num):
        ...
        if check_answer(question_sym, answer):
            ...
            print("Wrong. Correct answer is ", question_sym, ".Remember to check where you went wrong before moving on.")
